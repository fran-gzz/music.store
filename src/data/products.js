...
export const products = [
    {
        ...
        shipping: true,
        stock: 6,
        image: 'https://frangonzalez-dev.github.io/repo-imagenes/img/jazz.webp',
        description: "The American Professional II Jazzmaster takes the classic Fender look and jazzes it up even more. The popular deep “C” neck design now features smooth rolled fingerboard edges, a satin finish and a newly sculpted neck heel for a supremely comfortable feel along the entire fretboard. New V-Mod II Jazzmaster single-coil pickups are more articulate than ever and include a tap function that allows both a powerful, throaty sound as well as a traditional lower-output sound. The Jazzmaster American Professional II also features a new Panorama tremolo system with a pop-in tremolo arm that dramatically increases the range of vibrato available, allowing for deep, Strat-style dives, I addition to the classic Jazzmaster warble"
    },
    {
        id: 'tele',
    ...
    },
    {
        ...
        shipping: false,
        stock: 8,
        image: 'https://frangonzalez-dev.github.io/repo-imagenes/img/strato.webp',
    ...
    },
    {
        ...
        shipping: true,
        stock: 1,
        image: 'https://frangonzalez-dev.github.io/repo-imagenes/img/ts9.webp',
        description: "The Ibanez TS9 Tube Screamer is a reissue that's just like the original in so many ways. Same factory, same components, same housing, same famous seasick-green paint, and the same crankin' overdrive that made the original one of the all-time classic pedals. Guitar Player called it the best. Plug it in. Crank it up. You'll hear what all the fuss is about. Tone, drive, and level controls."
    },
    {
        id:'ds1',
        name: 'BOSS DS-1',
        ...
        shipping: true,
        stock: 3,
        image: 'https://frangonzalez-dev.github.io/repo-imagenes/img/ds1.webp',
